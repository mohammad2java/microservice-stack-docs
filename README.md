...
| ----- | ------------------------------ | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- |
| 1️⃣   | API Gateway                    | Spring Cloud Gateway (SCG)                                  | Acts as a single entry point for all client requests. Handles routing, authentication, rate limiting, and monitoring across multiple microservices.    | `spring-cloud-gateway-poc` repo                 |
